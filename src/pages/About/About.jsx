...
function About() {
  return (
    <main className="min-h-screen pt-24 pb-20 px-6 bg-[#fafafa]">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
        <div className="w-full lg:w-1/2 relative flex justify-center mt-8 lg:mt-0">
          <div className="absolute top-4 -left-4 md:top-8 md:-left-8 w-full max-w-md h-full border-2 border-[#d33a11]/30 z-0"></div>
